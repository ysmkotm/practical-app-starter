...
|BLG-CMN-015|CMN|EMP001・EMP002 UI パターンの共通化・標準化|DEP001／DEP002完成により「2画面目」の条件が揃ったため着手（2026-08-05）。common.cssの`employee-*`/`department-*`クラス（page-header・breadcrumb・form-card等）で内容が完全一致するものを、画面名に依存しない共通クラスへ統一する。チェックボックス・日付等フィールド種別に依存するスタイルは画面名ではなくフィールド種別基準に見直す。fragmentファイル自体の統合（breadcrumb-employee.html/breadcrumb-department.html）は別途判断|Version 1.x（2 画面目以降で回収）|検討中|[`progress.md`](progress.md) §3、[`EMP001_社員一覧.md`](../05_screen/EMP001_社員一覧.md) §8.6、[`EMP002_社員登録・編集.md`](../05_screen/EMP002_社員登録・編集.md) §8.6、[`DEP001_部署一覧.md`](../05_screen/DEP001_部署一覧.md) §8.6、[`DEP002_部署登録・編集.md`](../05_screen/DEP002_部署登録・編集.md) §8.6、[`common.css`](../../src/main/resources/static/css/common.css)、[`ui.md`](../02_rules/ui.md) §2.4・§4.2。子項目：BLG-CMN-003、BLG-CMN-010、BLG-CMN-011、BLG-CMN-016、BLG-CMN-019|
