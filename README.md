...
業務システムの再現可能な型 ― 開発ドキュメントを正本に、人と AI で進める
...
- **開発ドキュメント**：[`docs/`](docs/) 配下でソースと一体管理（全体像・読み方は [`docs/README.md`](docs/README.md)）

<!-- TODO: 「docs 構成」のスクリーンショットまたは短いGIFをここに挿入 -->

- **AIとの役割分担ルール**：[`docs/02_rules/ai.md`](docs/02_rules/ai.md) に明文化

<!-- TODO: 「AI方針」のスクリーンショットまたは短いGIFをここに挿入 -->

- **判断記録**：技術選定や設計変更の理由・却下案を [`docs/07_decisions`](docs/07_decisions/) に蓄積

<!-- TODO: 「判断記録」のスクリーンショットまたは短いGIFをここに挿入 -->

- **再利用プロンプト**：代表例を [`prompts/`](prompts/) に公開

<!-- TODO: 「プロンプト代表例」のスクリーンショットまたは短いGIFをここに挿入 -->
